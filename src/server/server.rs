    ...
    pub async fn start(&self) {
        ...
        HttpServer::new(move || {
            App::new()
                ...
                .service(web::resource("/api/game/{game_id}/continents").route(web::get().to(continent_list_action)))
                ...
                .service(web::resource("/api/game/{game_id}/clubs/{club_id}").route(web::get().to(club_get_action)))
