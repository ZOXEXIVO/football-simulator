...
impl GoalkeeperStrategies {
    pub fn process(
        ...
        let state_handler: StateHandler = match player.state {
            ...
            PlayerState::Goalkeeper(GoalkeeperState::HoldingBall) => GoalkeeperHoldingState::process,
            PlayerState::Goalkeeper(GoalkeeperState::Throwing) => GoalkeeperThrowingState::process,
            PlayerState::Goalkeeper(GoalkeeperState::PickingUpBall) => GoalkeeperPickingUpState::process,
            PlayerState::Goalkeeper(GoalkeeperState::Distributing) => GoalkeeperDistributingState::process,
            PlayerState::Goalkeeper(GoalkeeperState::ComingOut) => GoalkeeperComingOutState::process,
            PlayerState::Goalkeeper(GoalkeeperState::ReturningToGoal) => GoalkeeperReturningGoalState::process,
            ...
            PlayerState::Goalkeeper(GoalkeeperState::UnderPressure) => GoalkeeperPressureState::process,
            PlayerState::Goalkeeper(GoalkeeperState::Shooting) => GoalkeeperShootingState::process,
            PlayerState::Goalkeeper(GoalkeeperState::PreparingForSave) => GoalkeeperPreSaveState::process,
            PlayerState::Goalkeeper(GoalkeeperState::PenaltySave) => GoalkeeperPenaltyState::process,
            _ =>  {
                unimplemented!()
            }
        };
