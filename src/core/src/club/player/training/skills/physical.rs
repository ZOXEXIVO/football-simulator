...
use crate::{MentalFocusType, PhysicalFocusType, Player, Staff, TechnicalFocusType};
...
pub fn determine_physical_skills_to_increase(
    ...
    let base_increase_amount =
        determine_physical_skills_increase_amount(weeks_since_last_training, player, coach);
